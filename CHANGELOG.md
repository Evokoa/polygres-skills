...
- Added deterministic pipeline-plan guards that reject target schema changes,
  ...
  non-dashboard sync control on synchronized projects.
...
- Directed synchronized-project creation, preflight, table selection,
  reconfiguration, and lifecycle work to the dashboard, with source
  credentials kept out of agent-visible paths.
