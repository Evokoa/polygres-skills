...
creates a standard project; it does not create a synchronized PostgreSQL
project. For `project_mode: synced`, follow `synced-projects.md` and hand
creation, preflight, source selection, and lifecycle work to the dashboard.
